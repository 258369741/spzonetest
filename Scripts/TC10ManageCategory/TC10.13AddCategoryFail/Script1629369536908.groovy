...
WebUI.click(findTestObject('Object Repository/Page_Sp zone/svg'))

WebUI.setText(findTestObject('Object Repository/Page_Sp zone/input__Cg_name'), 'hat')

WebUI.verifyTextPresent('ชื่อหมวดหมู่นี้มีในระบบแล้ว', false)
