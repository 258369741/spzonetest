...
WebUI.setText(findTestObject('Object Repository/Page_Sp zone/input_Add Address_A_phone'), '123456790')
...
WebUI.click(findTestObject('Page_Sp zone/button_submit_address'))

WebUI.verifyTextPresent('add new address', false)
