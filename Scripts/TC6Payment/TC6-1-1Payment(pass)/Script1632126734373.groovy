...
WebUI.click(findTestObject('Object Repository/Page_Sp zone/h4_thx  1234567890'))

WebUI.click(findTestObject('Object Repository/Page_Sp zone/button_next'))

WebUI.click(findTestObject('Page_Sp zone/p_select Image'))

WebUI.uploadFile(findTestObject('Page_Sp zone/uploadfile'), 'C:\\Users\\mmilk\\Downloads\\testpayment.jpg')

WebUI.click(findTestObject('Object Repository/Page_Sp zone/button_submit'))

WebUI.verifyTextPresent('Successful purchase', false)
